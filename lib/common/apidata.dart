class APIData {
  ...
  static const String domainLink = "https://kaliry.com/";
  ...
  static const String addToWatchlist = domainApiLink + 'create/watchlist?secret=';
  static const String deleteFromWatchlist = domainApiLink + 'delete/watchlist?secret=';
  static const String getAllWatchlist = domainApiLink + 'view/watchlist?secret=';
  static const String likeDislikeReview = domainApiLink + 'review/helpful/';
  static const String enrollInFreeCourse = domainApiLink + 'free/enroll?secret=';
  ...
  static const String liveClassAttendance = domainApiLink + 'live/attendance?secret=';
  ...
  static const String gMeetImage = domainLink + "images/googlemeet/profile_image/";
  ...
  // Constants
  static const String appName = "Kaliry";
  static const String secretKey = "29a8d2cd-fa2d-4d7a-aae2-89fddef1c63c";

  // To play google drive video
  static const String googleDriveApi = 'ENTER_GOOGLE_DRIVE_API_KEY_HERE';

  // Zoom details
  static const String zoomAppKey = "JyRzADSaS-e9ZW0Eh8soHA";
  static const String zoomSecretKey = "NUG8fDQD0F2hX6PQo1v2TuAtjeJrtNyo0il1";
