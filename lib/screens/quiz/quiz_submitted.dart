...
class QuizSubmitted extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle titleStyle = TextStyle(color: mode.titleTextColor, fontSize: 18.0, fontWeight: FontWeight.w500);
    final TextStyle trailingStyle = TextStyle(color: mode.easternBlueColor, fontSize: 20.0, fontWeight: FontWeight.bold);
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ListTile(
                      title: Text(translate("Total_Questions"), style: titleStyle),
                    ...
                    ListTile(
                      title: Text(translate("Correct_Answers"), style: titleStyle),
                      trailing: Text("$correct/${questions.length}", style: trailingStyle),
                    ),
                    ListTile(
                      title: Text(translate("Incorrect_Answers"), style: titleStyle),
            ...
            Row(
              ...
              children: <Widget>[
                ElevatedButton(
                  ...
                  child: Text(
                    translate("Back_"),
                    style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w500, color: mode.titleTextColor),
                  ),
