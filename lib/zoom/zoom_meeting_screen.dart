...
//   Timer timer;
//
//   ZoomMeetingScreen({Key key, meetingId, meetingPassword, userName}) : super(key: key) {
//     // Setting up the Zoom credentials
//     this.zoomOptions = new ZoomOptions(
//       domain: "zoom.us",
//       appKey: APIData.zoomAppKey, // Replace with with key got from the Zoom Marketplace
//       appSecret: APIData.zoomSecretKey, // Replace with with secret got from the Zoom Marketplace
//     );
//
...
//                         (timer) {
//                           controller.meetingStatus(this.meetingOptions.meetingId).then(
//                             (status) {
